  ...
  return (
    <div className="app">
      ...
      <main className="content">
        ...
        <p className="page-subtitle">{videos.length} vidéo(s) favorite(s)</p>
        <Pagination page={clampedPage} totalPages={totalPages} onChange={setPage} />
        {!loading && <VideoGrid videos={pageItems} onOpen={handleOpen} onToggleFavorite={toggleFavorite} emptyMessage="Aucun favori pour le moment." />}
      </main>
